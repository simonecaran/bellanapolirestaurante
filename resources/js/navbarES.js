        ...
        categories.forEach(category => {
          ...
          if(!categoria.includes(category.category)){
            ...
            categoryContainer.classList.add('mt-5')
              ...
              categoryContainer.innerHTML = `<h5>ENTRANTES DE MONTAÑA</h5>`
            ...
            categoryContainer.classList.add('mt-5')
              ...
              categoryContainer.innerHTML = `<h5>ENTRANTES DE MAR</h5>`
              menuContainer.appendChild(categoryContainer);
            ...
            let categoryContainer = document.createElement('div')
            categoryContainer.classList.add('mt-5')
              categoryContainer.innerHTML = `<h5>GUARNICIONES</h5>`
              menuContainer.appendChild(categoryContainer);
            ...
            let categoryContainer = document.createElement('div')
            categoryContainer.classList.add('mt-5')
              categoryContainer.innerHTML = `<h5>MENÚ INFANTIL</h5>`
              menuContainer.appendChild(categoryContainer);
            ...
            let categoryContainer = document.createElement('div')
            categoryContainer.classList.add('mt-5')
              categoryContainer.innerHTML = `<h5>POSTRES TÍPICOS NAPOLITANOS</h5>`
              menuContainer.appendChild(categoryContainer);
