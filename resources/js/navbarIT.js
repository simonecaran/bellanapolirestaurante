        ...
        categories.forEach(category => {
          ...
          if(!categoria.includes(category.category)){
            ...
            categoryContainer.classList.add('mt-5')
              ...
              categoryContainer.innerHTML = `<h5>Antipasti di terra</h5>`
            ...
            categoryContainer.classList.add('mt-5')
              ...
              categoryContainer.innerHTML = `<h5>Antipasti di mare</h5>`
              menuContainer.appendChild(categoryContainer);
            ...
            categoryContainer.classList.add('mt-5')
              ...
              categoryContainer.innerHTML = `<h5>Primi piatti</h5>`
              menuContainer.appendChild(categoryContainer);
            ...
            categoryContainer.classList.add('mt-5')
              ...
              categoryContainer.innerHTML = `<h5>Secondi piatti</h5>`
              menuContainer.appendChild(categoryContainer);
            ...
            let categoryContainer = document.createElement('div')
            categoryContainer.classList.add('mt-5')
              categoryContainer.innerHTML = `<h5>Contorni</h5>`
              menuContainer.appendChild(categoryContainer);
            ...
            let categoryContainer = document.createElement('div')
            categoryContainer.classList.add('mt-5')
              categoryContainer.innerHTML = `<h5>Bambini</h5>`
              menuContainer.appendChild(categoryContainer);
            ...
            let categoryContainer = document.createElement('div')
            categoryContainer.classList.add('mt-5')
              categoryContainer.innerHTML = `<h5>Dolci</h5>`
              menuContainer.appendChild(categoryContainer);
